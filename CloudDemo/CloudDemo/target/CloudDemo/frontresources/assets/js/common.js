 ...
 */
function login() {
    $("#form").attr("action", getBaseUrl() + "login/toLogin.do");
    $("#form").submit();
}

//请求注册页面
function register() {
    $("#form").attr("action", getBaseUrl() + "register/toRegister.do");
    $("#form").submit();
}
 ...
 */
function loadIndex() {
    window.location.href = getBaseUrl() + "/jsp/newest_question.jsp";
}
...
function showUserHeadImg(hotuserheadimg) {
    return contextPath + '/' + hotuserheadimg;
}
