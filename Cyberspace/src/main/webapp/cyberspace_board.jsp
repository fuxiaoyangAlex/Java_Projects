                ...
                <div class="comment-main">
                    <header class="comment-header">
                        <div class="comment-meta"><a class="comment-author" href="#">${vars.lmessage_user}</a>
                            <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20" class="f-r">${vars.lmessage_date}</time>
                        </div>
                    </header>
                    ...
                    <!--------------------------------------小评论开始处----------------------------------------------------------------------------------------------->
                        ...
                        <ul class="commentList">
                            ...
                            <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="images/user.png"></i></a>
                                <div class="comment-main">
                                    <header class="comment-header">
                                        <div class="comment-meta"><a class="comment-author" href="#">王壮2</a>
