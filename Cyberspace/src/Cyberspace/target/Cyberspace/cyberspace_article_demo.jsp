        ...
        <div class="container cl">
			...
			<nav class="nav navbar-nav nav-collapse w_menu" role="navigation">
					<ul class="cl">
						...
						<li><a href="testFiles/cyberspace_article.jsp" data-hover="文章">文章</a></li>
...
<section class="container">
  ...
  <div class="col-sm-9 col-md-9 mt-20">
  	...
  	<!--article list-->
			<ul class="index_arc">
				<c:forEach var="myArticle" items="${allArticle}">
				<li class="index_arc_item">
					<a href="#" class="pic">
						<img class="lazyload" data-original="${myArticle.article_pic}" alt="应该选" />
					</a>
					<h4 class="title"><a href="article_detail.html">${myArticle.article_title}</a></h4>
					<div class="date_hits">
						<span>${myArticle.article_time}</span>
						<span><a href="/article-lists/10.html">${myArticle.article_author}</a></span>
			...
			<!------------------------------------------------------------------------------------>
	            ...
	            <%--</a>--%>
	        <%--<h4 class="title"><a href="/article/4">　　　　　　　　　　　　　　　　</a></h4>--%>
	        <%--<div class="date_hits">--%>
	            <%--<span>　　　　　　　　</span>--%>
	            <%--<span>　　　　　　　</span>--%>
	            <%--<span>--%>
	                <%--<a href="/article?t=1">　　　　　　　　</a>--%>
	            <%--</span>--%>
	            <%--<p class="hits"><i  title="　　　　　　"></i>　　　</p>--%>
	            <%--<p class="commonts"><i  title="　　　　　　"></i> <span class="cy_cmt_count">　</span></p>--%>
	        <%--</div>--%>
	        <%--<div class="desc">　　　　　　</div>--%>
	    <%--</li>--%>
          <!------------------------------------------------------------------------------------>
