...
//修改密码
            ...
            $('#Exit_system').on('click', function(){
                layer.confirm('是否确定退出系统？', {
                    ...
                    function(){
                        location.href="adminLogoutServlet.do?name=<%= request.getSession().getAttribute("admin_name")%>"
                    });
            });
        });
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <img src="images/cyberspace_logo.png" width="200" height="78">
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,<span>${admin.admin_name}</span></small>超级管理员</span>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="admin_home.jsp" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                    <li>
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="javascript:void(0)" name="Products_List.l"  title="" class="iframeurl"><i class="icon-double-angle-right"></i>文章列表</a></li>
                            <li class="home"><a  href="javascript:void(0)" name="Brand_Manage.html" title="文章分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>文章分类管理</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 相册管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="advertising.html" title="" class="iframeurl"><i class="icon-double-angle-right"></i>相册列表</a></li>
                            <li class="home"><a href="javascript:void(0)" name="Sort_ads.html" title=""  class="iframeurl"><i class="icon-double-angle-right"></i>相册分类管理</a></li></ul></li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 评论管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="${pageContext.request.contextPath}/adminGetAllInfoServlet.do" name="administrator_.jsp" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="administrator_.jsp">  </iframe>
...
<div class="footer_style" id="footerstyle">
    ...
    <p class="l_f">小组成员：<font color="#1e90ff"><b>[王壮壮 付晓阳 张志华 何靖]</b></font>
        　　　　　　　　　　　　　　　　　　　　　　　　　　<b>版权所有 ©2018 Cyberspace Github:<a href="https://github.com/Eirckwang"><font color="blue">https://github.com/Eirckwang</font></a></b>
    </p>
</div>
<!--修改密码样式-->
